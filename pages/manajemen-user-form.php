<div class="section-header">
	<h6 style="vertical-align: middle;">Tambah User Baru</h6>
	<div class="section-header-breadcrumb">
		<div class="breadcrumb-item active"><a href="#">Home</a></div>
		<div class="breadcrumb-item"><a href="?page=manajemen-user">Manajemen User</a></div>
		...
		<div class="col-md-6 mb-4 mb-md-0">
			<div class="card shadow-sm p-3 mb-5 bg-white rounded">
				<div class="card-body" style="margin-bottom: -17px;">
					...
					<div class="form-group row">
						<label class="col-sm-3 col-form-label"><b>Group User</b></label>
						<div class="col-sm-9">
		...
		<div class="col-md-6">
			<div class="card shadow-sm p-3 mb-5 bg-white rounded">
				<div class="card-body" style="margin-bottom: -32px;">
					...
					<div class="form-group row">
						<label class="col-sm-4 col-form-label"><b>Konfirmasi Password</b></label>
						<div class="col-sm-8">
							<input type="text" class="form-control">
						</div>
					</div>
