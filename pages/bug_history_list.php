<div class="section-header">
	<h7 style="vertical-align: middle;"><b>R/2021/I/0033 -</b>
		<b class="text-primary"> Aplikasi Historia</b>
		- Dinas Kebudayaan Daerah Istimewa Yogyakarta</h7>
	<div class="section-header-breadcrumb">
		<div class="breadcrumb-item active"><a href="#">Home</a></div>
		<div class="breadcrumb-item"><a href="?page=project">History Project</a></div>
		<div class="breadcrumb-item">List Bug</div>
	</div>
</div>
<div class="section-body">
	<div class="mb-4">
		<a href="?page=bug_form" class="btn btn-primary">
			Tambah Bug Baru
		</a>
	</div>
	<div class="card">
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td>
								<a href="?page=bug_history_detail" class="btn btn-dark btn-sm">View</a>
							</td>
							<td>13 Maret 2022</td>
